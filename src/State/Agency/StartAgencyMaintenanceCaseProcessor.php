...
final class StartAgencyMaintenanceCaseProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): mixed
    {
        ...
        return $this->manager->start($case);
    }
    ...
    private function requireCase(array $uriVariables): AgencyMaintenanceCase
    {
        ...
        if (!$case instanceof AgencyMaintenanceCase) {
            throw new \App\Exception\UnavailableDataException('Maintenance case not found.');
        }
