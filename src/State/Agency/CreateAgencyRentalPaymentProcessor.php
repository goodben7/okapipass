...
/** @implements ProcessorInterface<CreateAgencyRentalPaymentDto, AgencyPayment> */
final class CreateAgencyRentalPaymentProcessor implements ProcessorInterface
{
    ...
    {
        \assert($data instanceof CreateAgencyRentalPaymentDto);

        return $this->manager->initiate($this->requireContract($uriVariables), $data);
    }
