...
/** @implements ProcessorInterface<AgencyEmbarkation|null, \App\Entity\PassDeclaration> */
final class DeclareEmbarkationProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): mixed
    {
        ...
        return $this->manager->declare($embarkation);
    }
}
