...
/** @implements ProcessorInterface<UpdateAgencyBookingStatusDto, AgencyBooking> */
final class UpdateAgencyBookingStatusProcessor implements ProcessorInterface
{
    ...
    {
        \assert($data instanceof UpdateAgencyBookingStatusDto);
        ...
        return $this->manager->updateStatus($booking, (string) $data->status);
    }
}
