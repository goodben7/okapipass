...
/** @implements ProcessorInterface<CompleteAgencyMaintenanceCaseDto|null, AgencyMaintenanceCase> */
final class CompleteAgencyMaintenanceCaseProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): mixed
    {
        ...
        return $this->manager->complete(
            $case,
            $data instanceof CompleteAgencyMaintenanceCaseDto ? $data : null,
        );
    }
